...
func TestIsHexAddress(t *testing.T) {
	tests := []struct {
		...
		{"TC5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"TC5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", true},
		{"TCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"TCAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", true},
		{"TC5aaeb6053f3e94c9b9a09f33669435e7ef1beaed1", false},
		{"TC5aaeb6053f3e94c9b9a09f33669435e7ef1beae", false},
		{"5aaeb6053f3e94c9b9a09f33669435e7ef1beaed11", false},
		{"TCxaaeb6053f3e94c9b9a09f33669435e7ef1beaed", false},
	}
...
func TestAddressUnmarshalJSON(t *testing.T) {
	var tests = []struct {
		...
		{`"TC"`, true, nil},
		{`"TC00"`, true, nil},
		{`"TCG000000000000000000000000000000000000000"`, true, nil},
		{`"TC0000000000000000000000000000000000000000"`, false, big.NewInt(0)},
		{`"TC0000000000000000000000000000000000000010"`, false, big.NewInt(16)},
	}
...
func TestAddressHexChecksum(t *testing.T) {
	var tests = []struct {
		...
		{"TC5aaeb6053f3e94c9b9a09f33669435e7ef1beaed", "TC5aAeb6053F3E94C9b9A09f33669435E7Ef1BeAed"},
		{"TCfb6916095ca1df60bb79ce92ce3ea74c37c5d359", "TCfB6916095ca1df60bB79Ce92cE3Ea74c37c5d359"},
		{"TCdbf03b407c01e7cd3cbea99509d93f8dddc8c6fb", "TCdbF03B407c01E7cD3CBea99509d93f8DDDC8C6FB"},
		{"TCd1220a0cf47c7b9be7a2e6ba89f429762e7b9adb", "TCD1220A0cf47c7B9Be7A2E6BA89F429762e7b9aDb"},
		// Ensure that non-standard length input values are handled correctly
		{"0xa", "TC000000000000000000000000000000000000000A"},
		{"0x0a", "TC000000000000000000000000000000000000000A"},
		{"0x00a", "TC000000000000000000000000000000000000000A"},
		{"0x000000000000000000000000000000000000000a", "TC000000000000000000000000000000000000000A"},
	}
	for i, test := range tests {
