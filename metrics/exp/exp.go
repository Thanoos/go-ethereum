...
import (
	...
	promegus "github.com/ethereum/go-ethereum/metrics/promgus"
)
...
func Exp(r metrics.Registry) {
	...
	http.Handle("/debug/metrics/promegus", promegus.Handler(r))
}
...
func Setup(address string) {
	...
	m.Handle("/debug/metrics/promegus", promegus.Handler(metrics.DefaultRegistry))
