...
type downloadTester struct {
	...
	stateDb gdb.Database // Database used by the tester for syncing from peers
	peerDb  gdb.Database // Database of the peers containing all data
...
func TestCanonicalSynchronisation66Fast(t *testing.T)  { testCanonSync(t, g.G66, FastSync) }
...
func TestThrottling66Fast(t *testing.T) { testThrottling(t, g.G66, FastSync) }
...
func TestForkedSync66Fast(t *testing.T)  { testForkedSync(t, g.G66, FastSync) }
...
func TestHeavyForkedSync66Fast(t *testing.T)  { testHeavyForkedSync(t, g.G66, FastSync) }
...
func TestBoundedForkedSync66Fast(t *testing.T)  { testBoundedForkedSync(t, g.G66, FastSync) }
...
func TestBoundedHeavyForkedSync66Fast(t *testing.T) {
	testBoundedHeavyForkedSync(t, g.G66, FastSync)
}
...
func TestCancel66Fast(t *testing.T)  { testCancel(t, g.G66, FastSync) }
...
func TestMultiSynchronisation66Fast(t *testing.T)  { testMultiSynchronisation(t, g.G66, FastSync) }
...
func TestMultiProtoSynchronisation66Fast(t *testing.T)  { testMultiProtoSync(t, g.G66, FastSync) }
...
func testMultiProtoSync(t *testing.T, protocol uint, mode SyncMode) {
	...
	tester.newPeer("peer 66", g.G66, chain)
	//tester.newPeer("peer 65", g.G67, chain)
...
func TestEmptyShortCircuit66Fast(t *testing.T)  { testEmptyShortCircuit(t, g.G66, FastSync) }
...
func TestMissingHeaderAttack66Fast(t *testing.T)  { testMissingHeaderAttack(t, g.G66, FastSync) }
...
func TestShiftedHeaderAttack66Fast(t *testing.T)  { testShiftedHeaderAttack(t, g.G66, FastSync) }
...
func TestInvalidHeaderRollback66Fast(t *testing.T) { testInvalidHeaderRollback(t, g.G66, FastSync) }
...
func TestHighTDStarvationAttack66Fast(t *testing.T) {
	testHighTDStarvationAttack(t, g.G66, FastSync)
}
...
func TestSyncProgress66Fast(t *testing.T)  { testSyncProgress(t, g.G66, FastSync) }
...
func TestForkedSyncProgress66Fast(t *testing.T)  { testForkedSyncProgress(t, g.G66, FastSync) }
...
func TestFailedSyncProgress66Fast(t *testing.T)  { testFailedSyncProgress(t, g.G66, FastSync) }
...
func TestFakedSyncProgress66Fast(t *testing.T)  { testFakedSyncProgress(t, g.G66, FastSync) }
...
func TestDeliverHeadersHang66Full(t *testing.T)  { testDeliverHeadersHang(t, g.G66, FullSync) }
func TestDeliverHeadersHang66Fast(t *testing.T)  { testDeliverHeadersHang(t, g.G66, FastSync) }
func TestDeliverHeadersHang66Light(t *testing.T) { testDeliverHeadersHang(t, g.G66, LightSync) }
...
func TestCheckpointEnforcement66Fast(t *testing.T) { testCheckpointEnforcement(t, g.G66, FastSync) }
