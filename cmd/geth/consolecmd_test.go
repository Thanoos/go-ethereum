...
const (
	ipcAPIs  = "admin:1.0 debug:1.0 engine:1.0 g:1.0 gash:1.0 miner:1.0 net:1.0 personal:1.0 rpc:1.0 txpool:1.0 web3:1.0"
...
func TestConsoleWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.acbase", coinbase, "console")
...
func TestAttachWelcome(t *testing.T) {
	...
	geth := runMinimalGeth(t, "--miner.acbase", "0x8605cdbbdb6d264aa742e77020dcbc58fcdce182",
		"--ipcpath", ipc,
...
func testAttachWelcome(t *testing.T, geth *testgeth, endpoint, apis string) {
	...
	attach.SetTemplateFunc("acbase", func() string { return geth.ACbase })
